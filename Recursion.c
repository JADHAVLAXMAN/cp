...
int binary_recursive(int a[], int low, int high, int x);
int binary_iterative(int a1[], int low1, int high1, int x1);

int main()
{
    int ch;
    int num, arr[100], i, key;
    int lower_bound, upper_bound, result_recursive;
    ...
    while (num > 0)
    {
        ...
        case 2:
            ...
            {
                printf("\nEleme nt is Found using Binary Recursive");
                printf("\n At Location %d", result_recursive + 1);
            }
...
int binary_recursive(int a1[], int low1, int high1, int x1)
{
    ...
    if (x1 == a1[mid])
        ...
        return binary_recursive(a1, low1, mid - 1, x1);
    else
